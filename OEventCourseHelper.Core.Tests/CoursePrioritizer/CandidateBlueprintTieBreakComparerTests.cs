...
public class CandidateBlueprintTieBreakComparerTests
{
    ...
    {
        // Setup
        var x = new CandidateBlueprint(new CandidateSolution([], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
        var y = new CandidateBlueprint(new CandidateSolution([], new([]), new([]), 2UL), new(1, "Other", new([]), 0), 0UL);
    ...
    {
        // Setup
        var x = new CandidateBlueprint(new CandidateSolution([], new([]), new([]), 2UL), new(1, "Other", new([]), 0), 0UL);
        var y = new CandidateBlueprint(new CandidateSolution([], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
    ...
    private void Compare_ShouldReturnNegative_WhenXIsEmptyAndYIsNotEmpty()
    {
        // Setup
        var x = new CandidateBlueprint(new CandidateSolution([], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
        var y = new CandidateBlueprint(new CandidateSolution([defaultCourse], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
    ...
    {
        // Setup
        var x = new CandidateBlueprint(new CandidateSolution([defaultCourse], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
        var y = new CandidateBlueprint(new CandidateSolution([], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
    ...
    private void Compare_ShouldReturnNegative_WhenFirstInXHasLowerCourseIndex()
    {
        // Setup
        var x = new CandidateBlueprint(new CandidateSolution([defaultCourse], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
        var y = new CandidateBlueprint(new CandidateSolution([defaultCourse with { CourseIndex = 1 }], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
    ...
    {
        // Setup
        var x = new CandidateBlueprint(new CandidateSolution([defaultCourse with { CourseIndex = 1 }], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
        var y = new CandidateBlueprint(new CandidateSolution([defaultCourse], new([]), new([]), 1UL), new(1, "Other", new([]), 0), 0UL);
