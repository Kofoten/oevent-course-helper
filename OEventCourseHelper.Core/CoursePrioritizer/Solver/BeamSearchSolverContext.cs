...
/// </summary>
/// <param name="TargetControlsMask">A <see cref="BitMask"/> representing all controls that must be visited for a solution to be finished.</param>
...
/// <param name="CourseInvertedIndex">An inverted index containing a <see cref="BitMask"/> containing the indicies of each course covering a specific control.</param>
